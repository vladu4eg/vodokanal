        ...
        public Pokaz(string text)
        {
            ...
            try
            {
                ...
                myCommand.CommandText = string.Format("select inv_n, vvod_id,dest_name, vodom_id,dat_start,dat_end, Pokaz.DAT_IND," +
                    ...
                    "from Pokaz " +
                    "where Pokaz.INV_N = '" + inv_nomer.ToString() + "' " +
                ...
                listView1.Columns.Add("Инвентарный", 100);
                listView1.Columns.Add("Ввод", 80);
                listView1.Columns.Add("Тип", 80);
                listView1.Columns.Add("Номер водомера", 80);
                listView1.Columns.Add("Старт", 80);
                listView1.Columns.Add("Конец", 80);
                listView1.Columns.Add("Дата показ", 80);
                listView1.Columns.Add("СтартПок", 80);
                listView1.Columns.Add("КонечПок", 80);
                listView1.Columns.Add("Кубы", 80);
                listView1.Columns.Add("Контролер?", 100);
                listView1.Columns.Add("Кто проверл", 100);
                listView1.Columns.Add("Статус", 100);

                listView2.Columns.Add("Инвентарный", 100);
                listView2.Columns.Add("Ввод", 80);
                listView2.Columns.Add("Номер водомера", 80);
                listView2.Columns.Add("Тип", 80);
                listView2.Columns.Add("Дата рег", 80);
                listView2.Columns.Add("Тип2", 80);
                listView2.Columns.Add("Дата установки", 80);
                listView2.Columns.Add("СтартПок", 80);
                listView2.Columns.Add("Статус", 80);
                listView2.Columns.Add("Ласт госповерка", 80);
                listView2.Columns.Add("След гос", 80);
                listView2.Columns.Add("Ласт показ", 80);
                listView2.Columns.Add("ЛастКонтрПоказ", 80);
                listView2.Columns.Add("ЛастДатаКонПоказ", 80);
                listView2.Columns.Add("ЛастКонтр", 80);
                ...
                myCommand.CommandText = string.Format("select vdm.INV_N,vvod_id, id, type_name_r, dat_bidach, dest_name_r, dat_set, start_indication, t_state_name_r, ldat_testing, ndat_testing, last_indication," +
                    ...
                    "concat(rayon_name_r, ', ', trim(vidul_name_sr), vdm.ULICA_NAME_R, ', ', trim(dom_name), ',корп. ', korp, ', кв.', kvart) " +
                    "from vdm " +
                    "where vdm.INV_N = '" + inv_nomer.ToString() + "' " +
